...
Baixe e instale a versão mais recente da [CLI do Azure](/cli/azure/install-azure-cli?view=azure-cli-latest) para sua estação de trabalho.
...
No `C:\Chef directory`, execute o seguinte comando:
