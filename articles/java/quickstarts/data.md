---
title: Inícios rápidos para dados para aplicativos Java no Azure
description: Lista de materiais de introdução na documentação do Azure para dados para aplicativos Java.
ms.date: 04/09/2020
ms.topic: conceptual
...
ms.locfileid: "81673702"
---
# <a name="data-for-java-apps-on-azure"></a>Dados para aplicativos Java no Azure

Os seguintes artigos ajudam você com uma introdução a várias opções de dados no Azure:

- [MySQL](/azure/mysql/connect-java)
- [PostgreSQL](/azure/postgresql/connect-java)
- [Banco de Dados SQL](/azure/sql-database/sql-database-connect-query-java)
