...
ms.locfileid: "90832032"
---
# <a name="azure-monitor"></a>Azure Monitor

Este exemplo recupera as métricas de um recurso no Azure (VMs etc.).

Uma lista completa das palavras-chave disponíveis para filtros está disponível [aqui](/rest/api/monitor/metrics)
