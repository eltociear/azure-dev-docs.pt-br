---
title: Referência da API de biblioteca do SDK do Azure – Python
ms.date: 05/26/2020
ms.topic: conceptual
...
ms.locfileid: "84202875"
---
# <a name="azure-libraries-for-python-api-reference"></a>Referência da API de bibliotecas do Azure para Python

Referência completa para todos os serviços:

> [!div class="nextstepaction"]
> [Navegador de API do Python >>>](/python/api/?view=azure-python)

Estamos realizando o piloto de seções de referência por serviço, começando com Armazenamento (blobs, arquivos, filas). [Forneça comentários][1] sobre essa experiência.

> [!div class="nextstepaction"]
> [Experimente o piloto de referência de Armazenamento > > >](/azure/developer/python/sdk/storage/overview)
