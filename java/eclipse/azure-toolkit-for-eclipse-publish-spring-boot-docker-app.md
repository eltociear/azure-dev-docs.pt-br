---
title: Publicar um aplicativo Spring Boot como um contêiner do Docker
...
ms.locfileid: "75191118"
---
# <a name="publish-a-spring-boot-app-as-a-docker-container-by-using-the-azure-toolkit-for-eclipse-deprecated"></a>Publicar um aplicativo Spring Boot como um contêiner do Docker usando o Azure Toolkit for Eclipse (PRETERIDO)
...
As etapas a seguir explicam a clonagem do repositório do Spring Boot Docker para o computador local usando o IntelliJ. Se desejar usar uma linha de comando, consulte [Implantar um aplicativo Spring Boot no Linux no Serviço de Contêiner do Azure][Deploy Spring Boot on Linux in AKS].
