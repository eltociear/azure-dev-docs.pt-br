---
title: 'Tutorial: Adicionar uma segunda função de Python ao Azure Functions com o Visual Studio Code'
...
Após sua primeira implantação, você pode fazer alterações no código, como adicionar mais funções e reimplantar no mesmo Aplicativo de Funções.
